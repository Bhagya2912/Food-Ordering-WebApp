...
const Menu = () => {
  ...
  // For "Popular Food Items" section scrolling
  ...
  const restaurants = [
  {
    ...
    image: "https://b.zmtcdn.com/data/pictures/chains/0/18564420/313c34595541181e6132f9476b209e62_featured_v2.jpg",
    rating: 4.5,
    menuImage: "https://5.imimg.com/data5/SELLER/Default/2023/12/369633483/SE/ST/QF/87459547/paper-restaurant-menu-card-printing-service.jpeg", // sample image
    description: "The Spice House is a popular restaurant with multiple locations across India, including Jp Nagar in Bangalore, Shastri Nagar in Kullu, and various locations in Pune.Authentic Indian dishes made with traditional spices and rich flavors.",
    menu: [
  ...
  },
  {
    ...
    rating: 4.8,
    menuImage: "https://5.imimg.com/data5/SELLER/Default/2022/4/PU/EJ/GK/4196722/restaurant-menu-card.png",
    description: "Located in the vibrant heart of mandaveli, Ocean Delight is a cherished culinary haven where tradition meets innovation. Known for its commitment to quality ingredients, delightful flavors, and exceptional service, Ocean Delight invites you to savor a dining experience like no other.Seafood specialties straight from the ocean to your plate.",
  },
  {
    id: 3,
    name: "Green Garden",
              ...
              return (
                <div
                  ...
                  className={`absolute transition-all duration-500 ease-in-out rounded-xl overflow-hidden shadow-2xl transform ${
                    isActive
                      ? "scale-110 z-30"
                      : "scale-75 z-10 blur-sm opacity-80"
                  }`}
                  style={{
                ...
                >
                  ...
                  <div className="flex justify-between mt-3">
                    <button
                      ...
                      className="bg-emerald-600 text-white py-1 px-5 rounded hover:bg-emerald-700"
                    >
                    ...
                    <button
                      ...
                      className="bg-white text-red-500 px-3 py-1.5 rounded-full border border-red-300 hover:bg-red-50"
                    >
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {restaurants.map((restaurant) => (
            <div
              key={restaurant.id}
              className="cursor-pointer rounded-lg shadow-lg overflow-hidden hover:shadow-2xl bg-white"
              onClick={() =>
       ...
       {selectedRestaurant && (
  <div className="mt-12 max-w-3xl mx-auto bg-white rounded-lg shadow-xl p-6 border text-center">
    ...
    <button
      ...
      className="mt-6 px-4 py-2 bg-orange-600 text-white rounded hover:bg-red-600"
    >
      Close
    </button>
  </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 px-4">
          {visiblefoods.map((food, index) => (
            ...
            >
              ...
              <button
                onClick={() => (!isLoggedIn ? navigate("/login") : addToWishlist(food))}
  ...
  {`
    ...
    .scrollbar-hide { 
      ...
      scroll-behavior: smooth;  /* <-- Add this for smooth scroll */
    }
  `}
</style>
