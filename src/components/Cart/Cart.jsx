...
const Cart = () => {
  ...
  const discount = 10.00; // example coupon discount
  const Shipping =50;
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className=" mt-5 md:col-span-2 bg-white p-6 rounded-lg shadow-md ">
          ...
          <div className="mt-6 flex justify-between items-center">
            ...
            <button onClick={clearCart} className="text-green-600 text-sm underline">Clear Food Cart</button>
          </div>
        </div>
        ...
        <div className="mt-5 bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="text-sm space-y-2">
            <div className="flex justify-between"><span>Items</span><span>{cartItems.reduce((acc, i) => acc + i.quantity, 0)}</span></div>
